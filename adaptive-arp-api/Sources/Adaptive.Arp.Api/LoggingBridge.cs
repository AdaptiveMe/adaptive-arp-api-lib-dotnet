...
public class LoggingBridge : BaseUtilBridge, ILogging, APIBridge
{
          ...
          */
          public LoggingBridge(ILogging _delegate) : base()
          {
          ...
          */
          ...
          /**
             ...
             @param _delegate The delegate implementing platform specific functions.
          */
          public void SetDelegate(ILogging _delegate)
          {
               this._delegate = _delegate;
          }
          ...
          */
          public void Log(ILoggingLogLevel level, string category, string message)
          {
               if (this._delegate != null)
               {
                    this._delegate.Log(level, category, message);
                    }
          ...
          public new APIResponse Invoke(APIRequest request)
          {
               ...
               switch (request.GetMethodName())
               {
                    ...
                    default:
                         // 404 - response null.
                         responseCode = 404;
                         responseMessage = "LoggingBridge does not provide the function '"+request.GetMethodName()+"' Please check your client-side API version; should be API version >= v2.2.9.";
                         break;
               }
