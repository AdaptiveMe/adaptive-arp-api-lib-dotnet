...
public class MailBridge : BasePIMBridge, IMail, APIBridge
{
          ...
          */
          public MailBridge(IMail _delegate) : base()
          {
          ...
          */
          ...
          /**
             ...
             @param _delegate The delegate implementing platform specific functions.
          */
          public void SetDelegate(IMail _delegate)
          {
               this._delegate = _delegate;
          }
          ...
          */
          public new APIResponse Invoke(APIRequest request)
          {
               ...
               {
                    case "sendEmail":
                         Email data0 = GetJSONProcessor().DeserializeObject<Email>(request.GetParameters()[0]);
                    ...
                    default:
                         // 404 - response null.
                         responseCode = 404;
                         responseMessage = "MailBridge does not provide the function '"+request.GetMethodName()+"' Please check your client-side API version; should be API version >= v2.2.3.";
                         break;
               }
