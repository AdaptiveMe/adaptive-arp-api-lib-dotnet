...
public class VideoBridge : BaseMediaBridge, IVideo, APIBridge
{
          ...
          */
          public VideoBridge(IVideo _delegate) : base()
          {
          ...
          */
          ...
          /**
             ...
             @param _delegate The delegate implementing platform specific functions.
          */
          public void SetDelegate(IVideo _delegate)
          {
               this._delegate = _delegate;
          }
          ...
          public new APIResponse Invoke(APIRequest request)
          {
               ...
               switch (request.GetMethodName())
               {
                    ...
                    default:
                         // 404 - response null.
                         responseCode = 404;
                         responseMessage = "VideoBridge does not provide the function '"+request.GetMethodName()+"' Please check your client-side API version; should be API version >= v2.2.1.";
                         break;
               }
